...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-40 bg-ui-background rounded-ui-content p-ui-content border',
...
>(({ className, inset, variant = 'default', ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      'relative h-10 text-gray-900 focus:text-foreground p-ui-item justify-start gap-2 !ring-0 !ring-offset-0 outline-0 transition-colors rounded-ui-item flex items-center cursor-pointer focus:bg-ui-item-background-hover data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0',
      variant === 'destructive' && '!text-red-900 focus:!bg-red-100',
      inset && 'p-ui-item-inset',
      className,
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 flex items-center h-10 text-sm font-semibold',
      inset && 'pl-8',
      className,
    )}
    {...props}
