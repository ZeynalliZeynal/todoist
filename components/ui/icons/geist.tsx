...
export function BrandsAssets({ ...etc }: ComponentProps<'svg'>) {
  return (
    <svg
      fill="none"
      height="96"
    ...
    >
      ...
      ></line>
      <path
        d="M160.8 38C153.9 38 148.925 42.5 148.925 49.25C148.925 56 154.525 60.5 161.425 60.5C165.594 60.5 169.269 58.85 171.544 56.0688L166.762 53.3062C165.5 54.6875 163.581 55.4937 161.425 55.4937C158.431 55.4937 155.887 53.9313 154.944 51.4313H172.456C172.594 50.7313 172.675 50.0063 172.675 49.2438C172.675 42.5 167.7 38 160.8 38ZM154.887 47.0625C155.669 44.5688 157.806 43 160.794 43C163.787 43 165.925 44.5688 166.7 47.0625H154.887ZM228.1 38C221.2 38 216.225 42.5 216.225 49.25C216.225 56 221.825 60.5 228.725 60.5C232.894 60.5 236.569 58.85 238.844 56.0688L234.062 53.3062C232.8 54.6875 230.881 55.4937 228.725 55.4937C225.731 55.4937 223.187 53.9313 222.244 51.4313H239.756C239.894 50.7313 239.975 50.0063 239.975 49.2438C239.975 42.5 235 38 228.1 38ZM222.194 47.0625C222.975 44.5688 225.112 43 228.1 43C231.094 43 233.231 44.5688 234.006 47.0625H222.194ZM197.8 49.25C197.8 53 200.25 55.5 204.05 55.5C206.625 55.5 208.556 54.3313 209.55 52.425L214.35 55.1938C212.362 58.5063 208.637 60.5 204.05 60.5C197.144 60.5 192.175 56 192.175 49.25C192.175 42.5 197.15 38 204.05 38C208.637 38 212.356 39.9938 214.35 43.3063L209.55 46.075C208.556 44.1687 206.625 43 204.05 43C200.256 43 197.8 45.5 197.8 49.25ZM249.35 31.125V59.875H243.725V31.125H249.35ZM95.7437 28L118.837 68H72.6499L95.7437 28ZM153.481 31.125L136.162 61.125L118.844 31.125H125.337L136.162 49.875L146.987 31.125H153.481ZM190.3 38.625V44.6812C189.675 44.5 189.012 44.375 188.3 44.375C184.669 44.375 182.05 46.875 182.05 50.625V59.875H176.425V38.625H182.05V44.375C182.05 41.2 185.744 38.625 190.3 38.625Z"
