  ...
  theme: {
  	...
  	extend: {
  		...
  		colors: {
  			...
  			dashed: 'linear-gradient(to right, hsl(var(--ds-gray-400-value)), hsl(var(--ds-gray-400-value)) 50%, transparent 0, transparent)'
  		},
  		borderColor: {
  		...
  		backgroundImage: {
  			...
  			skeleton: 'linear-gradient(270deg,hsl(var(--ds-accent-100-value)),hsl(var(--ds-accent-200-value)),hsl(var(--ds-accent-200-value)),hsl(var(--ds-accent-100-value)))'
  		},
  		boxShadow: {
  			'header-border': 'hsl(var(--header-border))',
  			input: '0 0 0 1px hsl(var(--ds-gray-alpha-600-value)),0 0 0 4px hsl(0,0%,100%,.24)!important',
